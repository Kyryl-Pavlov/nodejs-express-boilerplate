...
- `SECRET_KEY` — 64-char random string; reserved app-wide secret, not currently consumed by any Express-specific mechanism, kept for parity/future cookie-signing use
